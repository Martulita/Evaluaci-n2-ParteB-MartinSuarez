...
key = "69a2604a-446c-4a93-a490-256d0b205342"      # Replace with your Graphhopper API key
...
while True:
    ...
    vehicle = input("ingresa un vehiculo de la lista de arriba: ")
    if vehicle == "salir" or vehicle == "s":
        ...
        vehicle = "car"
        print("perfil de vehiculo no valido. usando el perfil car")
